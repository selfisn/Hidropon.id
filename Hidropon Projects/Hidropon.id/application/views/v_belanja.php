            ...
            foreach ($this->cart->contents() as $items) {
             ...
             ?>
                    ...
                    <tr>
                            ...
                            <td style="text-align: center"><?= $berat_produk?> gr</td>
                            <td class="text-center">
                                <a href="<?= base_url('Belanja/delete/'.$items['rowid'])?>" class="btn btn-danger btn-sa"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
