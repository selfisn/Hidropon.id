...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="<?= base_url() ?>" class="navbar-brand">
        <img src="img/Hidropon.png" width="50px">
        <span class="brand-text font-weight-light"><b>HIDROPON.ID</b></span>
      </a>
        ...
        <li class="nav-item">
          ...
          <?php  } else { ?>
            <a class="nav-link" data-toggle="dropdown" href="#">
              ...
              <img src="<?= base_url('assets/img/foto/'. $this->session->userdata('foto')) ?>" class="brand-image
      ...
      ?>
        <li class="nav-item dropdown">
          ...
          <a href="#" class="dropdown-item">              
              <div class="media">
                <img src="<?= base_url('assets/img/' . $produk->foto_produk) ?>" alt="User Avatar" class="img-size-50  mr-3">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Hidropon.id</a></li>
