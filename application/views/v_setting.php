        ...
        <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <option value="<?= $setting->kode_lokasi ?>"><?= $setting->kode_lokasi ?></option>
                        </select>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_toko" value="<?= $setting->nama_toko ?>"class="form-control" required></input>
                      </div>
                    </div>
                  <div class="col-sm-6">
                    <div class="form-group">
...
<script>
      ...
      //memasukkan data ke select provinsi
        $.ajax({
            type: "POST",
        ...
        //memasukkan data ke select kota
