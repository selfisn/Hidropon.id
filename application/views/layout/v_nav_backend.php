      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            'admin' and $this->uri->segment(2)=="") {echo"active";}?>">
          ...
          <li class="nav-item">
            <a href="<?= base_url('foto_produk')?>" class="nav-link <?php if ($this->uri->segment(1) == 'foto_produk')
            {echo"active";}?>">
          ...
          <li class="nav-item">
            ...
            'pesanan_masuk' and $this->uri->segment(1)=='admin') {echo"active";}?>">
