...
<div class="card card-outline card-primary">
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                        ...
                        rows="5"><?= $produk->deskripsi_produk?></textarea>
                      </div>
                  ...
                  <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="file" name="foto_produk" class="form-control" id="preview_foto">
                      </div>
                  </div>

                  <div class="col-sm-6">
                      <div class="form-group">
                        <img src="<?= base_url('assets/img/'.$produk->foto_produk) ?>" id="foto_load" width="200px">
                      </div>
                  </div>
                  </div>
