...
{
    private $api_key = '1e09ec5d00c49c7e7244ecc47df9d967';
    ...
    {
        $id_kota_asal = $this->M_admin->data_setting()->kode_lokasi;
        ...
        foreach ($data_paket as $key => $value) {
            echo "<option value='".$value['service'].".".$value['cost'][0]['value']."' estimasi='".$value['cost'][0]['etd']." Hari'>";
